...
from scripts.data_processor.utils.pandas.auxiliary import (
    drop_all_na_rows, drop_duplicates, fill_na_values,
    cast_cols_to_numeric, clean_id_cols
)
...
def process_data(config):
    ...
    pd_processor.apply_function(
        fill_na_values, 
        cols_to_fill=["total_complaints_2021",'total_complaints_2022', 'total_complaints_2023'], 
        fill=0
    )
    pd_processor.apply_function(
        cast_cols_to_numeric, 
        cols_to_cast=['total_complaints_2021', 'total_complaints_2022', 'total_complaints_2023']
    )
